...
async def scrape_duckduckgo(
    ...
    """
    Scrape DuckDuckGo HTML version for business websites.
    """
    ...
    try:
        ...
        for result in results:
            ...
            # Clean up title (remove " - Home", "| City", etc.)
        ...
        logger.info(f"DuckDuckGo: Found {len(extracted_data)} valid company websites")
        ...
        logger.error(f"DuckDuckGo processing error: {e}")
        return extracted_data
