/**
 * Centralized prompts for generative models (Ollama).
 */
export const PromptRegistry = {
    quickAudit: `You are an expert business analyst. Analyze the following company profile and extract: Company Summary, Business Model, Services, Target Audience.`,
